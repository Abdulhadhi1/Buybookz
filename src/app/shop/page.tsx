...
import { Search, Loader2, ArrowRight, ArrowUpDown, Filter } from "lucide-react";
      ...
      <section className="py-16 px-6 lg:px-12 max-w-7xl mx-auto">
        {loading ? (
            <div className="flex flex-col items-center justify-center py-40 space-y-6">
                ...
                <p className="text-[10px] font-black uppercase tracking-[0.4em] opacity-30 italic text-accent">Summoning Records...</p>
            </div>
            ...
            <div className="text-center py-40 space-y-8 bg-secondary/5 rounded-[4rem] border border-dashed border-border/30">
                <div className="space-y-3">
                    <h3 className="text-2xl font-serif text-primary/30 tracking-tight italic">No records match your selection.</h3>
                    <p className="text-[10px] font-black uppercase tracking-widest text-foreground/20">Expand your search criteria or reset filters.</p>
                </div>
                <button 
